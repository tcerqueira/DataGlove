...
// Mpu9250 object
Imu imus[NUMIMUS] = {
    Imu(&Wire, Imu::I2C_ADDR_SEC, IMU0_GX_OFFSET, IMU0_GY_OFFSET, IMU0_GZ_OFFSET),
    Imu(&Wire, Imu::I2C_ADDR_PRIM, IMU1_GX_OFFSET, IMU1_GY_OFFSET, IMU1_GZ_OFFSET),
    Imu(&Wire, Imu::I2C_ADDR_SEC, IMU2_GX_OFFSET, IMU2_GY_OFFSET, IMU2_GZ_OFFSET),
    Imu(&Wire, Imu::I2C_ADDR_PRIM, IMU3_GX_OFFSET, IMU3_GY_OFFSET, IMU3_GZ_OFFSET),
    Imu(&Wire, Imu::I2C_ADDR_SEC, IMU4_GX_OFFSET, IMU4_GY_OFFSET, IMU4_GZ_OFFSET),
    ...
    Imu(&Wire, Imu::I2C_ADDR_PRIM, IMU9_GX_OFFSET, IMU9_GY_OFFSET, IMU9_GZ_OFFSET),
    Imu(&Wire, Imu::I2C_ADDR_SEC, IMU10_GX_OFFSET, IMU10_GY_OFFSET, IMU10_GZ_OFFSET),
    Imu(&Wire, Imu::I2C_ADDR_PRIM, IMU11_GX_OFFSET, IMU11_GY_OFFSET, IMU11_GZ_OFFSET)
};
